...
class _UsuarioModalState extends State<UsuarioModal> {
  ...
  Widget _buildProfileContent(Usuario user) {
    ...
    const Color textColor = Color(
      0xFF333333,
    ); // Cor de texto escura (preto/cinza escuro)
    const Color fieldBackgroundColor = Color(
      0xFFF0F4F8,
    ); // Azul bem claro para o fundo dos campos
    const Color iconCloseColor = Color(
      0xFF555555,
    ); // Cor para o ícone de fechar

    return SingleChildScrollView(
      child: ConstrainedBox(
        constraints: const BoxConstraints(maxWidth: 350),
        // Largura máxima um pouco menor
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              CircleAvatar(
                ...
                backgroundImage:
                    (user.fotoPerfilUrl != null &&
                        ...
                        : const AssetImage(
                              'assets/logo/passageiro_placeholder.png',
                            )
                            as ImageProvider,
                // Placeholder
              ...
              // Espaço maior antes dos campos de informação
              _buildInfoField(
                label: 'Email:',
              ...
              const SizedBox(height: 12),
              BotaoWhatsapp(numeroWhatsapp: user.numeroCelular ?? ''),
              const SizedBox(height: 16),
              // Espaço no final do modal
            ],
          ),
        ),
      ),
